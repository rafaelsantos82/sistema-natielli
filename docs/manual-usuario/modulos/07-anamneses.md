...
**Endereço na barra de endereços:** `/anamneses`  
**Quem usa:** Profissionais e recepção.
...
3. Clique em **Anamneses**.

## Tela principal

![Tela Anamneses](manual-usuario/screenshots/clinico/anamneses.png)
...
- Preencher ou visualizar respostas de anamnese por paciente.
