...
| Rota SPA | `/prontuarios, /prontuario/:consultaId` |
| Permissão RBAC | `menu.prontuarios.view` |
| Feature flag | `VITE_API_PRONTUARIO` |
| Página | `src/pages/Prontuarios.tsx, Prontuario.tsx` |
...
| Artefato | Caminho |
|----------|---------|
| Rotas | `backend/internal/interfaces/http/routes/register_prontuario.go` |
...
```mermaid
flowchart LR
  User[Usuario] --> Page[Pagina_prontuarios]
