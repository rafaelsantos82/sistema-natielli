...
| Rota SPA | `/comodato` |
| Permissão RBAC | `menu.comodato.view` |
| Feature flag | `VITE_API_COMODATO` |
| Página | `src/pages/Comodato.tsx` |
...
| Artefato | Caminho |
|----------|---------|
| Rotas | `backend/internal/interfaces/http/routes/register_comodatos.go` |
...
```mermaid
flowchart LR
  User[Usuario] --> Page[Pagina_comodato]
